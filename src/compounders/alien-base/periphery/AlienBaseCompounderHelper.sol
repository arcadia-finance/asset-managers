...
/**
 * @title Off-chain view functions for Alien Base Compounder Asset-Manager.
 * @author Pragma Labs
 ...
 */
contract AlienBaseCompounderHelper {
    ...
    // The Alien Base Quoter contract.
    // ToDo: Replace with the actual quoter address.
    IQuoter internal constant QUOTER = IQuoter(0x2ba1d35920DB74a1dB97679BC27d2cBa81bB96ea);
    ...
    /**
     * @param compounder The contract address of the Asset-Manager for compounding Alien Base fees of a certain Liquidity Position.
     */
    ...
    {
        IUniswapV3Pool pool = IUniswapV3Pool(AlienBaseLogic._computePoolAddress(token0, token1, fee));
