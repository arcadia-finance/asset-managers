 ...
 */
contract SetInitiator_UniswapV3Compounder_Fuzz_Test is UniswapV3Compounder_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_setInitiator_NotAnAccount(address caller, address account_, address initiator_) public {
        ...
        // Then: it should revert.
        vm.prank(caller);
        vm.expectRevert(UniswapV3Compounder.NotAnAccount.selector);
    ...
    function testFuzz_Revert_setAccountInfo_OnlyAccountOwner(address caller, address initiator_) public {
        ...
        // Then: it should revert.
        vm.prank(caller);
        vm.expectRevert(UniswapV3Compounder.OnlyAccountOwner.selector);
