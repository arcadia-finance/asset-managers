...
contract Constructor_UniswapV4Compounder_Fuzz_Test is UniswapV4Compounder_Fuzz_Test {
    ...
    function testFuzz_Revert_Constructor_UnderflowTolerance(
        ...
        new UniswapV4Compounder(compoundThreshold, initiatorShare, tolerance);
    }
        ...
        public
    {
        ...
        vm.prank(users.owner);
        UniswapV4Compounder compounder_ = new UniswapV4Compounder(compoundThreshold, initiatorShare, tolerance);
