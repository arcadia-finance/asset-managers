 ...
 */
contract Burn_BurnLogic_Fuzz_Test is BurnLogic_Fuzz_Test, UniswapV3Fixture, SlipstreamFixture {
    ...
    function setUp() public override(BurnLogic_Fuzz_Test, UniswapV3Fixture, SlipstreamFixture) {
