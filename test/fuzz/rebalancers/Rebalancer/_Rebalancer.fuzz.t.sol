 ...
 */
abstract contract Rebalancer_Fuzz_Test is Fuzz_Test, UniswapV3Fixture {
    /*////////////////////////////////////////////////////////////////
                            CONSTANTS
    /////////////////////////////////////////////////////////////// */
    ...
    function setUp() public virtual override(Fuzz_Test, UniswapV3Fixture) {
        ...
        rebalancer = new RebalancerExtension(address(factory), MAX_TOLERANCE, MAX_INITIATOR_FEE, MIN_LIQUIDITY_RATIO);
    }
