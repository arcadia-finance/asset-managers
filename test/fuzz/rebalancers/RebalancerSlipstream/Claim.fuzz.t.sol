...
/**
 * @notice Fuzz tests for the function "_claim" of contract "RebalancerSlipstream".
 */
contract Claim_RebalancerSlipstream_Fuzz_Test is RebalancerSlipstream_Fuzz_Test {
    ...
    function testFuzz_Success_claim_Slipstream(
        ...
        (balances, fees) = rebalancer.claim(balances, fees, address(slipstreamPositionManager), position, claimFee);
    ...
    function testFuzz_Success_claim_StakedSlipstream_RewardTokenNotToken0Or1(
        ...
        (balances, fees) = rebalancer.claim(balances, fees, address(stakedSlipstreamAM), position, claimFee);
    ...
    function testFuzz_Success_claim_WrappedStakedSlipstream_RewardTokenNotToken0Or1(
        ...
        // When: Calling claim.
        uint256[] memory fees = new uint256[](balances.length);
        (balances, fees) = rebalancer.claim(balances, fees, address(wrappedStakedSlipstream), position, claimFee);
