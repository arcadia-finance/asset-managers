...
/**
 * @notice Fuzz tests for the function "_unstake" of contract "RebalancerSlipstream".
 */
contract Unstake_RebalancerSlipstream_Fuzz_Test is RebalancerSlipstream_Fuzz_Test {
    ...
    function testFuzz_Success_unstake_Slipstream(
        ...
        balances = rebalancer.unstake(balances, address(slipstreamPositionManager), position);
    ...
    function testFuzz_Success_unstake_StakedSlipstream_RewardTokenNotToken0Or1(
        ...
        // When: Calling unstake.
        balances = rebalancer.unstake(balances, address(stakedSlipstreamAM), position);
    ...
    function testFuzz_Success_unstake_WrappedStakedSlipstream_RewardTokenNotToken0Or1(
        ...
        // When: Calling unstake.
        balances = rebalancer.unstake(balances, address(wrappedStakedSlipstream), position);
