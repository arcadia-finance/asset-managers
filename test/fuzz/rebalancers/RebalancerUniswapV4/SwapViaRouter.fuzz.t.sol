...
/**
 * @notice Fuzz tests for the function "_swapViaRouter" of contract "RebalancerV4".
 */
contract SwapViaRouter_RebalancerUniswapV4_Fuzz_Test is RebalancerUniswapV4_Fuzz_Test {
    ...
    function testFuzz_Revert_swapViaRouter_Router(
        ...
        rebalancer.swapViaRouter(v4PoolKey, position, true, swapData);
    }
    ...
    function testFuzz_Success_swapViaRouter_ZeroToOne_UniswapV3(
        ...
        bytes memory swapData = abi.encode(address(routerMock), uint256(amountIn), data);
        (uint256 balance0_, uint256 balance1_, RebalancerUniswapV4.PositionState memory position_) =
            rebalancer.swapViaRouter(v4PoolKey, position, false, swapData);
