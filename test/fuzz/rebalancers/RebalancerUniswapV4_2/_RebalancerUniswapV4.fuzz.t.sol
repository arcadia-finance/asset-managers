...
import { RebalancerUniswapV4Extension } from "../../../utils/extensions/RebalancerUniswapV4_2Extension.sol";
...
abstract contract RebalancerUniswapV4_Fuzz_Test is Fuzz_Test, UniswapV4Fixture {
    ...
    function givenValidPositionState(Rebalancer.PositionState memory position) internal view {
