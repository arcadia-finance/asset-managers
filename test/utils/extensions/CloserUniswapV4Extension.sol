...
import { CloserUniswapV4 } from "../../../src/cl-managers/closers/CloserUniswapV4.sol";
import { PositionState } from "../../../src/cl-managers/state/PositionState.sol";

contract CloserUniswapV4Extension is CloserUniswapV4 {
    constructor(
        address owner_,
        ...
        address poolManager,
        address weth
    ) CloserUniswapV4(owner_, arcadiaFactory, positionManager, permit2, poolManager, weth) { }
