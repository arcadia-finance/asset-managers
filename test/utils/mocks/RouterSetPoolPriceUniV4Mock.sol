...
contract RouterSetPoolPriceUniV4Mock {
    function swap(address poolManager, PoolId poolId, int24 tick, uint160 sqrtPriceX96) external {
        IPoolManagerExtension(poolManager).setCurrentPrice(poolId, tick, sqrtPriceX96);
    }
}
